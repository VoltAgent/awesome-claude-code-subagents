...
- [**skillfold**](https://github.com/byronxlg/skillfold) - YAML pipeline compiler for multi-agent teams - compile-time skill composition, typed state, and flow orchestration
