...
- [**structured-debugger**](categories/04-quality-security/structured-debugger.md) - Phase-gated debugging with enforced reproduce → isolate → root cause → fix → verify protocol
